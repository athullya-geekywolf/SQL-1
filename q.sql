...
GROUP BY P.PRODUCTID;---PRINTS NULL FOR PRODUCTS NOT SOLD

SELECT P.PRODUCTID, COALESCE(SUM(S.QUANTITY*S.UNITPRICE),0) AS SALES_AMOUNT
FROM PRODUCTS P
LEFT JOIN SALES S ON S.PRODUCTID=P.PRODUCTID
GROUP BY P.PRODUCTID;----- PRINTS 0 FOR PRODUCTS NOT SOLD
